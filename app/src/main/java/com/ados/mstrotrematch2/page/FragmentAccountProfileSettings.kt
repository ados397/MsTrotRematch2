...
import com.ados.mstrotrematch2.databinding.FragmentAccountProfileSettingsBinding
...
class FragmentAccountProfileSettings : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (currentUserEx?.userDTO?.loginType) {
            ...
            UserDTO.LoginType.EMAIL -> binding.editLoginType.setText("이메일 로그인")
            else -> binding.editLoginType.setText("비회원 로그인")
        }
                        ...
                        firebaseViewModel.isUsedUserNickname(nickname) { isUsed ->
                            if (isUsed) {
                                ...
                                if (currentUserEx?.userDTO?.nickname != nickname) {
                                    ...
                                    firebaseViewModel.updateUserNickname(currentUserEx?.userDTO!!, 0) { userDTO ->
                                        if (userDTO != null) {
