...
import com.ados.mstrotrematch2.adapter.OnQuestItemClickListener
import com.ados.mstrotrematch2.adapter.RecyclerViewAdapterQuest
import com.ados.mstrotrematch2.databinding.ActivityQuestBinding
...
class QuestActivity : AppCompatActivity(), OnQuestItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        quests.add(QuestDTO("일일 과제 모두 달성", "모든 일일 과제를 완료 하세요", 2, null, currentUser?.questGemGetTimes?.get("0")))
        quests.add(QuestDTO("투표하기", "최애에게 1표 이상 투표하기", 1, currentUser?.questSuccessTimes?.get("1"), currentUser?.questGemGetTimes?.get("1")))
        quests.add(QuestDTO("응원하기", "응원글 1회 작성하기", 1, currentUser?.questSuccessTimes?.get("2"), currentUser?.questGemGetTimes?.get("2")))
        quests.add(QuestDTO("좋아요", "응원글 좋아요 1회 누르기", 1, currentUser?.questSuccessTimes?.get("3"), currentUser?.questGemGetTimes?.get("3")))
        quests.add(QuestDTO("무료 다이아", "광고 보고 무료 다이아 1회 받기", 1, currentUser?.questSuccessTimes?.get("4"), currentUser?.questGemGetTimes?.get("4")))
        quests.add(QuestDTO("출석체크", "출석체크하고 다이아 받기", 1, currentUser?.questSuccessTimes?.get("5"), currentUser?.questGemGetTimes?.get("5")))
