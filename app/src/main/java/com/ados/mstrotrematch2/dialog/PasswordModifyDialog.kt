...
import com.ados.mstrotrematch2.databinding.PasswordModifyDialogBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editPasswordNew.doAfterTextChanged {
            if (!isValidPassword(binding.editPasswordNew.text.toString())) {
                binding.textPasswordNewError.text = "비밀번호는 8자 이상 영문 대소문자, 숫자, 특수문자 중 2종류 이상 조합하여야 합니다."
