...
import com.ados.mstrotrematch2.databinding.ListItemQuestBinding
            ...
            with(holder) {
                ...
                if (position == 0) { // 일일 과제 모두 달성
                    ...
                    if (count == (items.size-1) && !item.isQuestGemGet()) { // 모든 일일 퀘스트 완료
                        ...
                        buttonGet.background = AppCompatResources.getDrawable(context!!, R.drawable.btn_round_disable)
