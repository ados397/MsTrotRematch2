...
import com.ados.mstrotrematch2.databinding.ListItemQnaBinding
import com.ados.mstrotrematch2.model.QnaDTO
        ...
        items[position].let { item ->
            with(holder) {
                ...
                if (!item.imageUrl.isNullOrEmpty()) {
                    Glide.with(imgContent.context).load(item.imageUrl).optionalFitCenter().into(imgContent)
